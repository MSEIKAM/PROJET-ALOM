...
public class AllerController {
	...
	public Response sendMessage(String jsonPayload) {
	    ...
	    try {
	        ...
	        // Appeler le microservice d'authentification pour récupérer le nom de l'utilisateur
	        ...
	        if (response.getStatus() == 200) {
	            ...
	            if (messageResponse.getStatus() == 200) {
	                ...
	                System.out.println("Erreur lors de l'envoi du message : " + messageResponse.getStatusInfo().toString());
